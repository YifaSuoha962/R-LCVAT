...
from utils.data_loader import G2SFullDataset
    ...
    for epoch in tot_epochs:
        ...
        for step, batch in zip(tstep, data_loader):
            ...
            with torch.cuda.amp.autocast(enabled=True):
                loss, token_acc, seq_acc, true_token_count, all_token_count, sub_loss = module.model_train(batch, epoch, tot_epochs)
